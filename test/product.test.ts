...
describe("GET /products", () => {
  ...
  it("should get products", async () => {
    const response = await supertest(web).get("/products?most_sold=true");
...
describe("GET /products/:productId", () => {
  ...
  it("should get product by id", async () => {
    const response = await supertest(web).get("/products/1234test");
    console.log(response.body);
    expect(response.status).toBe(200);
  ...
  it("should failed not found get product by id", async () => {
    const response = await supertest(web).get("/products/1234tesnotfound");
    console.log(response.body);
    expect(response.status).toBe(404);
    expect(response.body.errors).toBeDefined();
  });
...
describe("GET /stores/:storeId/products", () => {
  ...
  it("should get product by store id", async () => {
    const response = await supertest(web).get("/stores/123/products");
    console.log(response.body);
    expect(response.status).toBe(200);
  ...
  it("should get product by store id", async () => {
    const response = await supertest(web).get("/stores/1213/products");
    console.log(response.body);
    expect(response.status).toBe(404);
    expect(response.body.errors).toBeDefined();
  });
